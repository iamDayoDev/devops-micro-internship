...
Read `settings.local.json` for AWS credentials and region. Use these values in the generated Terraform files.

Use $ARGUMENTS for optional overrides:
- $0 = AWS region (default: ap-south-1)
- $1 = Project name (default: portfolio-site-aderinto-adedayo-7684)
